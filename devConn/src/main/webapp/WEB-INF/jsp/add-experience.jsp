    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 m-auto">
          ...
          <form action="experienceAdder" method="post">
            ...
            <h6>From Date</h6>
            <div class="form-group">
              <input type="date" class="form-control form-control-lg" name="from" required/>
            </div>
            <h6>To Date</h6>
            <div class="form-group">
            ...
            <div class="form-group">
              <textarea class="form-control form-control-lg" placeholder="Job Description" name="description" required></textarea>
