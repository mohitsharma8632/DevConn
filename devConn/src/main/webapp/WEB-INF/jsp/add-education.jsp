    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 m-auto">
          ...
          <form action="educationAdder" method="post">
            ...
            <h6>From Date</h6>
            <div class="form-group">
              <input type="date" class="form-control form-control-lg" placeholder="year-month-day format" name="from" required/>
            </div>
            <h6>To Date</h6>
            <div class="form-group">
              <input type="date" class="form-control form-control-lg" placeholder="year-month-day format if current not required" name="to" />
            </div>
            <div class="form-group">
              <textarea class="form-control form-control-lg" placeholder="Program Description" name="description" required></textarea>
