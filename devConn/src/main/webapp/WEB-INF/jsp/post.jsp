            ...
            <div class="row">
              <div class="col-md-4">
                <a href="profile?email=${p.email}">
                  <img class="rounded-circle d-none d-md-block" src="propic.jsp?email=${p.email}"  width="180" height="180"
                    alt="" />
                </a>
                <br />
              ...
              <div class="card-body">
                <form action="commenter" method="post">
                  <div class="form-group">
                    <textarea class="form-control form-control-lg" placeholder="Create a comment" name="comment"></textarea>
                  </div>
...
<div class="card card-body mb-3">
              <div class="row">
                <div class="col-md-4">
                  <a href="profile?email=${c.email}">
                    <img class="rounded-circle d-none d-md-block" src="propic.jsp?email=${c.email}"  width="150" height="150" />
                  </a>
                  <br />
  ...
  <footer class="bg-dark text-white mt-5 p-4 text-center">
    Copyright &copy; 2020 Dev Connector ${name}
  </footer>
